...
class InvokeAIGenerator(metaclass=ABCMeta):
    ...
    def generate(
        ...
        **keyword_args,
        ...
        with model_info.context as model:
            ...
            iteration_count = (
                range(iterations) if iterations else itertools.count(start=0, step=1)
            )
    ...
    def load_generator(
        self, model: StableDiffusionGeneratorPipeline, generator_class: Type[Generator]
    ):
    ...
    def generate(
        ...
        **keyword_args,
        ...
        return super().generate(
            init_image=init_image, strength=strength, **keyword_args
        )
